...
*)
Compute ( "BottleCastle_initial_block_4_0"%string, (equiv_checker [PUSH 1 (NToWord WLen 0x40%N);DUP 1;Opcode MLOAD;DUP 2;DUP 2;Opcode ADD;DUP 3] [PUSH 1 (NToWord WLen 0x40%N);DUP 1;Opcode MLOAD;DUP 1;DUP 3;Opcode ADD;DUP 3] 0 optimize_id) ).
...
*)
Compute ( "BottleCastle_initial_block_4_2"%string, (equiv_checker [PUSH 13 (NToWord WLen 0x426f74746c6520436173746c65%N);PUSH 1 (NToWord WLen 0x98%N);Opcode SHL;PUSH 1 (NToWord WLen 0x20%N);DUP 3;DUP 2;Opcode ADD;SWAP 2;DUP 3] [PUSH 13 (NToWord WLen 0x426F74746C6520436173746C65%N);PUSH 1 (NToWord WLen 0x98%N);Opcode SHL;PUSH 1 (NToWord WLen 0x20%N);DUP 1;DUP 4;Opcode ADD;SWAP 2;DUP 3] 1 optimize_id) ).
...
*)
Compute ( "BottleCastle_initial_block_17_1"%string, (equiv_checker [PUSH 1 (NToWord WLen 0x20%N);DUP 1;DUP 3;PUSH 1 (NToWord WLen 0x4%N);Opcode ADD] [PUSH 1 (NToWord WLen 0x20%N);PUSH 1 (NToWord WLen 0x4%N);DUP 3;Opcode ADD;DUP 2;SWAP 1] 1 optimize_id) ).
...
*)
Compute ( "BottleCastle_initial_block_52_0"%string, (equiv_checker [SWAP 4;POP;DUP 1;PUSH 1 (NToWord WLen 0x20%N);DUP 7;Opcode ADD;Opcode MLOAD;DUP 1;SWAP 4;POP;Opcode GT;Opcode ISZERO;PUSH 1 (NToWord WLen 0x4c%N)] [SWAP 4;POP;PUSH 1 (NToWord WLen 0x20%N);DUP 6;Opcode ADD;Opcode MLOAD;SWAP 2;POP;DUP 1;DUP 3;Opcode GT;Opcode ISZERO;PUSH 1 (NToWord WLen 0x4c%N)] 6 optimize_id) ).
...
*)
Compute ( "BottleCastle_initial_block_56_0"%string, (equiv_checker [DUP 1;PUSH 1 (NToWord WLen 0x1%N);Opcode SHR;DUP 2;PUSH 1 (NToWord WLen 0x1%N);Opcode AND;DUP 1;PUSH 1 (NToWord WLen 0x50%N)] [PUSH 1 (NToWord WLen 0x1%N);DUP 2;DUP 2;Opcode SHR;SWAP 1;DUP 3;Opcode AND;DUP 1;PUSH 1 (NToWord WLen 0x50%N)] 1 optimize_id) ).
...
*)
Compute ( "BottleCastle_run_code_of_0_block_181_0"%string, (equiv_checker [PUSH 1 (NToWord WLen 0x1%N);DUP 1;PUSH 1 (NToWord WLen 0xa0%N);Opcode SHL;Opcode SUB;DUP 1;SWAP 3;Opcode AND;PUSH 1 (NToWord WLen 0x0%N);SWAP 1;DUP 2] [PUSH 1 (NToWord WLen 0x1%N);PUSH 1 (NToWord WLen 0x1%N);PUSH 1 (NToWord WLen 0xA0%N);Opcode SHL;Opcode SUB;SWAP 2;DUP 3;Opcode AND;PUSH 1 (NToWord WLen 0x0%N);SWAP 1;DUP 2] 2 optimize_id) ).

(*
 I: PUSH 7 PUSH 20 SWAP1 DUP2
 O: PUSH 20 PUSH 7 DUP2
*)
Compute ( "BottleCastle_run_code_of_0_block_181_1"%string, (equiv_checker [PUSH 1 (NToWord WLen 0x20%N);PUSH 1 (NToWord WLen 0x7%N);DUP 2] [PUSH 1 (NToWord WLen 0x7%N);PUSH 1 (NToWord WLen 0x20%N);SWAP 1;DUP 2] 0 optimize_id) ).

(*
 I: PUSH 40 DUP1 DUP4 KECCAK256 SWAP4 SWAP1 SWAP5 AND DUP3
 O: PUSH 40 SWAP4 DUP5 DUP4 KECCAK256 SWAP4 AND DUP3
*)
Compute ( "BottleCastle_run_code_of_0_block_181_2"%string, (equiv_checker [PUSH 1 (NToWord WLen 0x40%N);SWAP 4;DUP 5;DUP 4;Opcode KECCAK256;SWAP 4;Opcode AND;DUP 3] [PUSH 1 (NToWord WLen 0x40%N);DUP 1;DUP 4;Opcode KECCAK256;SWAP 4;SWAP 1;SWAP 5;Opcode AND;DUP 3] 4 optimize_id) ).
...
*)
Compute ( "BottleCastle_run_code_of_0_block_198_1"%string, (equiv_checker [SWAP 2;SWAP 1;DUP 3;DUP 2;DUP 5] [DUP 1;SWAP 3;SWAP 2;SWAP 1;DUP 2;DUP 2] 3 optimize_id) ).
...
(*
 ...
 O: SWAP2 SWAP1 DUP3 DUP2 DUP5
*)
Compute ( "BottleCastle_run_code_of_0_block_211_1"%string, (equiv_checker [SWAP 2;SWAP 1;DUP 3;DUP 2;DUP 5] [DUP 1;SWAP 3;SWAP 2;SWAP 1;DUP 2;DUP 2] 3 optimize_id) ).
...
*)
Compute ( "BottleCastle_run_code_of_0_block_224_3"%string, (equiv_checker [SWAP 2;SWAP 1;DUP 6;SWAP 4;PUSH 32 (NToWord WLen 0x8c5be1e5ebec7d5bd14f71427d1e84f3dd0314c0f7b2291e5b200ac8c7c3b925%N);SWAP 2;DUP 7;Opcode AND;SWAP 3;Opcode MLOAD] [SWAP 2;Opcode MLOAD;DUP 6;SWAP 4;SWAP 2;DUP 6;Opcode AND;SWAP 2;PUSH 32 (NToWord WLen 0x8C5BE1E5EBEC7D5BD14F71427D1E84F3DD0314C0F7B2291E5B200AC8C7C3B925%N);SWAP 2] 6 optimize_id) ).
...
*)
Compute ( "BottleCastle_run_code_of_0_block_228_2"%string, (equiv_checker [PUSH 1 (NToWord WLen 0x40%N);SWAP 1;Opcode KECCAK256;DUP 5;PUSH 1 (NToWord WLen 0x1%N);DUP 1;PUSH 1 (NToWord WLen 0xa0%N);Opcode SHL;Opcode SUB;Opcode AND;Opcode CALLER;Opcode EQ;DUP 2;Opcode SLOAD;SWAP 1;Opcode CALLER;DUP 3;Opcode EQ;Opcode OR;PUSH 2 (NToWord WLen 0x104%N)] [PUSH 1 (NToWord WLen 0x40%N);SWAP 1;Opcode KECCAK256;DUP 1;Opcode SLOAD;Opcode CALLER;DUP 1;DUP 3;Opcode EQ;PUSH 1 (NToWord WLen 0x1%N);PUSH 1 (NToWord WLen 0x1%N);PUSH 1 (NToWord WLen 0xA0%N);Opcode SHL;Opcode SUB;DUP 9;Opcode AND;SWAP 1;SWAP 2;Opcode EQ;Opcode OR;PUSH 2 (NToWord WLen 0x104%N)] 5 optimize_id) ).
...
*)
Compute ( "BottleCastle_run_code_of_0_block_237_0"%string, (equiv_checker [DUP 4;PUSH 1 (NToWord WLen 0x1%N);Opcode ADD;PUSH 1 (NToWord WLen 0x0%N);DUP 2;DUP 2] [PUSH 1 (NToWord WLen 0x1%N);DUP 5;Opcode ADD;PUSH 1 (NToWord WLen 0x0%N);DUP 2;DUP 2] 4 optimize_id) ).
...
*)
Compute ( "BottleCastle_run_code_of_0_block_269_3"%string, (equiv_checker [DUP 1;SWAP 3;DUP 3;Opcode ADD] [SWAP 2;DUP 2;Opcode ADD;DUP 3;SWAP 1] 3 optimize_id) ).
...
*)
Compute ( "BottleCastle_run_code_of_0_block_277_0"%string, (equiv_checker [DUP 8;PUSH 1 (NToWord WLen 0x1%N);DUP 1;PUSH 1 (NToWord WLen 0xa0%N);Opcode SHL;Opcode SUB;DUP 1;DUP 8;Opcode AND;SWAP 2;Opcode AND;Opcode EQ;Opcode ISZERO;PUSH 2 (NToWord WLen 0x144%N)] [DUP 8;PUSH 1 (NToWord WLen 0x1%N);PUSH 1 (NToWord WLen 0x1%N);PUSH 1 (NToWord WLen 0xA0%N);Opcode SHL;Opcode SUB;Opcode AND;DUP 6;PUSH 1 (NToWord WLen 0x1%N);PUSH 1 (NToWord WLen 0x1%N);PUSH 1 (NToWord WLen 0xA0%N);Opcode SHL;Opcode SUB;Opcode AND;Opcode EQ;Opcode ISZERO;PUSH 2 (NToWord WLen 0x144%N)] 8 optimize_id) ).
...
*)
Compute ( "BottleCastle_run_code_of_0_block_282_0"%string, (equiv_checker [POP;POP;SWAP 6;SWAP 5;POP;POP;POP;POP;POP] [POP;SWAP 1;SWAP 7;SWAP 6;POP;POP;POP;POP;POP;POP] 9 optimize_id) ).
...
(*
 ...
 O: PUSH 20 PUSH 7 DUP2
*)
Compute ( "BottleCastle_run_code_of_0_block_305_1"%string, (equiv_checker [PUSH 1 (NToWord WLen 0x20%N);PUSH 1 (NToWord WLen 0x7%N);DUP 2] [PUSH 1 (NToWord WLen 0x7%N);PUSH 1 (NToWord WLen 0x20%N);SWAP 1;DUP 2] 0 optimize_id) ).
...
*)
Compute ( "BottleCastle_run_code_of_0_block_305_4"%string, (equiv_checker [DUP 2;DUP 7;Opcode ISZERO;Opcode ISZERO;SWAP 2;SWAP 5;Opcode KECCAK256;DUP 2;PUSH 1 (NToWord WLen 0xff%N);Opcode NOT;DUP 3;Opcode SLOAD;Opcode AND;Opcode OR;SWAP 1] [SWAP 3;DUP 2;SWAP 1;Opcode KECCAK256;DUP 1;Opcode SLOAD;PUSH 1 (NToWord WLen 0xFF%N);Opcode NOT;Opcode AND;DUP 7;Opcode ISZERO;Opcode ISZERO;SWAP 1;DUP 2;Opcode OR;SWAP 1;SWAP 2] 6 optimize_id) ).
...
(*
 ...
 O: SWAP2 SWAP1 DUP3 DUP2 DUP5
*)
Compute ( "BottleCastle_run_code_of_0_block_325_1"%string, (equiv_checker [SWAP 2;SWAP 1;DUP 3;DUP 2;DUP 5] [DUP 1;SWAP 3;SWAP 2;SWAP 1;DUP 2;DUP 2] 3 optimize_id) ).
...
(*
 ...
 O: PUSH 20 DUP1 DUP3 PUSH 4 ADD
*)
Compute ( "BottleCastle_run_code_of_0_block_353_1"%string, (equiv_checker [PUSH 1 (NToWord WLen 0x20%N);DUP 1;DUP 3;PUSH 1 (NToWord WLen 0x4%N);Opcode ADD] [PUSH 1 (NToWord WLen 0x20%N);PUSH 1 (NToWord WLen 0x4%N);DUP 3;Opcode ADD;DUP 2;SWAP 1] 1 optimize_id) ).
...
(*
 ...
 O: DUP1 SWAP3 DUP3 ADD
*)
Compute ( "BottleCastle_run_code_of_0_block_366_3"%string, (equiv_checker [DUP 1;SWAP 3;DUP 3;Opcode ADD] [SWAP 2;DUP 2;Opcode ADD;DUP 3;SWAP 1] 3 optimize_id) ).
...
*)
Compute ( "BottleCastle_run_code_of_0_block_366_10"%string, (equiv_checker [DUP 1;SWAP 2;Opcode ADD;DUP 3;PUSH 1 (NToWord WLen 0x1%N);PUSH 1 (NToWord WLen 0xe0%N);Opcode SHL;Opcode AND;Opcode ISZERO;Opcode ISZERO;SWAP 1] [PUSH 1 (NToWord WLen 0x1%N);PUSH 1 (NToWord WLen 0xE0%N);Opcode SHL;DUP 4;Opcode AND;Opcode ISZERO;Opcode ISZERO;SWAP 2;DUP 2;Opcode ADD;SWAP 2;SWAP 1;SWAP 2] 3 optimize_id) ).

(*
 I: PUSH E8 SWAP2 SWAP1 SWAP2 SHR PUSH 60 DUP3 ADD
 O: SWAP1 PUSH e8 SHR DUP2 PUSH 60 ADD
*)
Compute ( "BottleCastle_run_code_of_0_block_366_11"%string, (equiv_checker [SWAP 1;PUSH 1 (NToWord WLen 0xe8%N);Opcode SHR;DUP 2;PUSH 1 (NToWord WLen 0x60%N);Opcode ADD] [PUSH 1 (NToWord WLen 0xE8%N);SWAP 2;SWAP 1;SWAP 2;Opcode SHR;PUSH 1 (NToWord WLen 0x60%N);DUP 3;Opcode ADD] 2 optimize_id) ).
...
*)
Compute ( "BottleCastle_run_code_of_0_block_416_1"%string, (equiv_checker [PUSH 1 (NToWord WLen 0x20%N);PUSH 1 (NToWord WLen 0x5%N);DUP 2] [PUSH 1 (NToWord WLen 0x5%N);PUSH 1 (NToWord WLen 0x20%N);SWAP 1;DUP 2] 0 optimize_id) ).
...
*)
Compute ( "BottleCastle_run_code_of_0_block_416_6"%string, (equiv_checker [DUP 3;DUP 3;DUP 6;DUP 3;Opcode ADD;SWAP 3;PUSH 32 (NToWord WLen 0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef%N);DUP 2;DUP 3] [DUP 3;DUP 5;Opcode ADD;SWAP 1;DUP 4;SWAP 1;DUP 4;SWAP 1;PUSH 32 (NToWord WLen 0xDDF252AD1BE2C89B69C2B068FC378DAA952BA7F163C4A11628F55A4DF523B3EF%N);DUP 2;DUP 1] 4 optimize_id) ).
...
*)
Compute ( "BottleCastle_run_code_of_0_block_440_1"%string, (equiv_checker [SWAP 3;POP;DUP 3;DUP 6;DUP 2] [DUP 1;SWAP 4;POP;DUP 6;DUP 2] 6 optimize_id) ).
...
*)
Compute ( "BottleCastle_run_code_of_0_block_460_0"%string, (equiv_checker [SWAP 4;PUSH 1 (NToWord WLen 0x40%N);Opcode ADD;Opcode CALLDATALOAD;SWAP 4;SWAP 5;POP;POP;POP;SWAP 3] [SWAP 2;POP;PUSH 1 (NToWord WLen 0x40%N);DUP 5;Opcode ADD;Opcode CALLDATALOAD;SWAP 1;POP;SWAP 3;POP;SWAP 3;POP;SWAP 3] 7 optimize_id) ).
...
*)
Compute ( "BottleCastle_run_code_of_0_block_470_0"%string, (equiv_checker [SWAP 5;SWAP 8;SWAP 4;SWAP 7;POP;POP;POP;SWAP 3;POP] [SWAP 2;POP;POP;SWAP 3;SWAP 6;SWAP 2;SWAP 5;POP;SWAP 3;POP] 9 optimize_id) ).
...
*)
Compute ( "BottleCastle_run_code_of_0_block_478_0"%string, (equiv_checker [SWAP 5;SWAP 3;PUSH 1 (NToWord WLen 0x20%N);Opcode ADD;Opcode CALLDATALOAD;SWAP 4;POP;POP;POP] [SWAP 5;PUSH 1 (NToWord WLen 0x20%N);SWAP 4;SWAP 1;SWAP 4;Opcode ADD;Opcode CALLDATALOAD;SWAP 4;POP;POP;POP] 6 optimize_id) ).
...
*)
Compute ( "BottleCastle_run_code_of_0_block_504_0"%string, (equiv_checker [DUP 6;Opcode MLOAD;PUSH 2 (NToWord WLen 0x26d%N);DUP 2;DUP 4;DUP 10;Opcode ADD;SWAP 5;DUP 8;Opcode ADD;DUP 1;SWAP 6;PUSH 2 (NToWord WLen 0x26a%N)] [DUP 6;Opcode MLOAD;SWAP 2;DUP 5;Opcode ADD;SWAP 2;PUSH 2 (NToWord WLen 0x26d%N);DUP 2;DUP 5;DUP 5;DUP 11;Opcode ADD;PUSH 2 (NToWord WLen 0x26a%N)] 6 optimize_id) ).
...
*)
Compute ( "BottleCastle_run_code_of_0_block_517_0"%string, (equiv_checker [POP;POP;POP;POP;POP;SWAP 7;POP;POP;POP;POP;POP;POP;POP;SWAP 1] [POP;SWAP 4;SWAP 12;SWAP 11;POP;POP;POP;POP;POP;POP;POP;POP;POP;POP;POP] 14 optimize_id) ).
...
*)
Compute ( "BottleCastle_run_code_of_0_block_518_2"%string, (equiv_checker [DUP 3;DUP 2;PUSH 1 (NToWord WLen 0x40%N);Opcode ADD] [PUSH 1 (NToWord WLen 0x40%N);DUP 2;Opcode ADD;DUP 4;SWAP 1] 3 optimize_id) ).

(*
 I: PUSH 80 PUSH 60 DUP3 ADD DUP2 SWAP1
 O: PUSH 80 DUP1 DUP3 PUSH 60 ADD
*)
Compute ( "BottleCastle_run_code_of_0_block_518_3"%string, (equiv_checker [PUSH 1 (NToWord WLen 0x80%N);DUP 1;DUP 3;PUSH 1 (NToWord WLen 0x60%N);Opcode ADD] [PUSH 1 (NToWord WLen 0x80%N);PUSH 1 (NToWord WLen 0x60%N);DUP 3;Opcode ADD;DUP 2;SWAP 1] 1 optimize_id) ).
...
*)
Compute ( "BottleCastle_run_code_of_0_block_520_1"%string, (equiv_checker [DUP 3;Opcode MLOAD;DUP 1;DUP 3;DUP 5;Opcode ADD] [DUP 3;Opcode MLOAD;DUP 3;DUP 3;Opcode ADD;DUP 2;SWAP 1] 3 optimize_id) ).
...
*)
Compute ( "ERC721A_initial_block_22_0"%string, (equiv_checker [DUP 2;Opcode MLOAD;PUSH 1 (NToWord WLen 0x1%N);DUP 1;PUSH 1 (NToWord WLen 0x40%N);Opcode SHL;Opcode SUB;DUP 1;DUP 3;Opcode GT;Opcode ISZERO;PUSH 1 (NToWord WLen 0x1d%N)] [DUP 2;Opcode MLOAD;PUSH 1 (NToWord WLen 0x1%N);PUSH 1 (NToWord WLen 0x1%N);PUSH 1 (NToWord WLen 0x40%N);Opcode SHL;Opcode SUB;DUP 1;DUP 3;Opcode GT;Opcode ISZERO;PUSH 1 (NToWord WLen 0x1d%N)] 2 optimize_id) ).
...
*)
Compute ( "ERC721A_initial_block_24_0"%string, (equiv_checker [PUSH 1 (NToWord WLen 0x40%N);Opcode MLOAD;PUSH 1 (NToWord WLen 0x1f%N);Opcode NOT;PUSH 1 (NToWord WLen 0x3f%N);DUP 2;DUP 6;PUSH 1 (NToWord WLen 0x1f%N);Opcode ADD;Opcode AND;Opcode ADD;Opcode AND;Opcode ADD;PUSH 1 (NToWord WLen 0x40%N);Opcode MLOAD;DUP 3;DUP 3;Opcode GT;DUP 2;DUP 4;Opcode LT;Opcode OR;Opcode ISZERO;PUSH 1 (NToWord WLen 0x20%N)] [PUSH 1 (NToWord WLen 0x40%N);Opcode MLOAD;PUSH 1 (NToWord WLen 0x1F%N);DUP 4;Opcode ADD;PUSH 1 (NToWord WLen 0x1F%N);Opcode NOT;SWAP 1;DUP 2;Opcode AND;PUSH 1 (NToWord WLen 0x3F%N);Opcode ADD;Opcode AND;DUP 2;Opcode ADD;SWAP 1;DUP 3;DUP 3;Opcode GT;DUP 2;DUP 4;Opcode LT;Opcode OR;Opcode ISZERO;PUSH 1 (NToWord WLen 0x20%N)] 2 optimize_id) ).
...
(*
 ...
 O: DUP3 DUP3 DUP8 ADD ADD MLOAD DUP4 DUP4 DUP4 ADD ADD
*)
Compute ( "ERC721A_initial_block_30_0"%string, (equiv_checker [DUP 3;DUP 3;DUP 8;Opcode ADD;Opcode ADD;Opcode MLOAD;DUP 4;DUP 4;DUP 4;Opcode ADD;Opcode ADD] [DUP 6;DUP 3;Opcode ADD;DUP 4;Opcode ADD;Opcode MLOAD;DUP 2;DUP 4;Opcode ADD;DUP 5;Opcode ADD] 6 optimize_id) ).
...
*)
Compute ( "ERC721A_initial_block_39_0"%string, (equiv_checker [SWAP 4;POP;DUP 1;PUSH 1 (NToWord WLen 0x20%N);DUP 7;Opcode ADD;Opcode MLOAD;DUP 1;SWAP 4;POP;Opcode GT;Opcode ISZERO;PUSH 1 (NToWord WLen 0x2a%N)] [SWAP 4;POP;PUSH 1 (NToWord WLen 0x20%N);DUP 6;Opcode ADD;Opcode MLOAD;SWAP 2;POP;DUP 1;DUP 3;Opcode GT;Opcode ISZERO;PUSH 1 (NToWord WLen 0x2a%N)] 6 optimize_id) ).
...
*)
Compute ( "ERC721A_initial_block_43_0"%string, (equiv_checker [DUP 1;PUSH 1 (NToWord WLen 0x1%N);Opcode SHR;DUP 2;PUSH 1 (NToWord WLen 0x1%N);Opcode AND;DUP 1;PUSH 1 (NToWord WLen 0x2d%N)] [PUSH 1 (NToWord WLen 0x1%N);DUP 2;DUP 2;Opcode SHR;SWAP 1;DUP 3;Opcode AND;DUP 1;PUSH 1 (NToWord WLen 0x2d%N)] 1 optimize_id) ).
...
(*
 ...
 O: PUSH 20 PUSH 7 DUP2
*)
Compute ( "ERC721A_run_code_of_0_block_54_1"%string, (equiv_checker [PUSH 1 (NToWord WLen 0x20%N);PUSH 1 (NToWord WLen 0x7%N);DUP 2] [PUSH 1 (NToWord WLen 0x7%N);PUSH 1 (NToWord WLen 0x20%N);SWAP 1;DUP 2] 0 optimize_id) ).

(*
 I: PUSH 40 DUP1 DUP4 KECCAK256 SWAP4 SWAP1 SWAP5 AND DUP3
 O: PUSH 40 SWAP4 DUP5 DUP4 KECCAK256 SWAP4 AND DUP3
*)
Compute ( "ERC721A_run_code_of_0_block_54_2"%string, (equiv_checker [PUSH 1 (NToWord WLen 0x40%N);SWAP 4;DUP 5;DUP 4;Opcode KECCAK256;SWAP 4;Opcode AND;DUP 3] [PUSH 1 (NToWord WLen 0x40%N);DUP 1;DUP 4;Opcode KECCAK256;SWAP 4;SWAP 1;SWAP 5;Opcode AND;DUP 3] 4 optimize_id) ).
...
(*
 ...
 O: SWAP2 SWAP1 DUP3 DUP2 DUP5
*)
Compute ( "ERC721A_run_code_of_0_block_61_1"%string, (equiv_checker [SWAP 2;SWAP 1;DUP 3;DUP 2;DUP 5] [DUP 1;SWAP 3;SWAP 2;SWAP 1;DUP 2;DUP 2] 3 optimize_id) ).
...
*)
Compute ( "ERC721A_run_code_of_0_block_80_0"%string, (equiv_checker [DUP 1;SWAP 2;POP;PUSH 1 (NToWord WLen 0x1%N);DUP 1;PUSH 1 (NToWord WLen 0xa0%N);Opcode SHL;Opcode SUB;DUP 6;DUP 2;Opcode AND;SWAP 2;Opcode AND;Opcode EQ;PUSH 1 (NToWord WLen 0x6c%N)] [SWAP 1;POP;DUP 4;PUSH 1 (NToWord WLen 0x1%N);PUSH 1 (NToWord WLen 0x1%N);PUSH 1 (NToWord WLen 0xA0%N);Opcode SHL;Opcode SUB;Opcode AND;DUP 2;PUSH 1 (NToWord WLen 0x1%N);PUSH 1 (NToWord WLen 0x1%N);PUSH 1 (NToWord WLen 0xA0%N);Opcode SHL;Opcode SUB;Opcode AND;Opcode EQ;PUSH 1 (NToWord WLen 0x6c%N)] 5 optimize_id) ).
...
*)
Compute ( "ERC721A_run_code_of_0_block_82_2"%string, (equiv_checker [PUSH 1 (NToWord WLen 0x40%N);SWAP 1;Opcode KECCAK256;DUP 5;PUSH 1 (NToWord WLen 0x1%N);DUP 1;PUSH 1 (NToWord WLen 0xa0%N);Opcode SHL;Opcode SUB;Opcode AND;Opcode CALLER;Opcode EQ;DUP 2;Opcode SLOAD;SWAP 1;Opcode CALLER;DUP 3;Opcode EQ;Opcode OR;PUSH 1 (NToWord WLen 0x75%N)] [PUSH 1 (NToWord WLen 0x40%N);SWAP 1;Opcode KECCAK256;DUP 1;Opcode SLOAD;Opcode CALLER;DUP 1;DUP 3;Opcode EQ;PUSH 1 (NToWord WLen 0x1%N);PUSH 1 (NToWord WLen 0x1%N);PUSH 1 (NToWord WLen 0xA0%N);Opcode SHL;Opcode SUB;DUP 9;Opcode AND;SWAP 1;SWAP 2;Opcode EQ;Opcode OR;PUSH 1 (NToWord WLen 0x75%N)] 5 optimize_id) ).
...
(*
 ...
 O: DUP4 PUSH 1 ADD PUSH 0 DUP2 DUP2
*)
Compute ( "ERC721A_run_code_of_0_block_91_0"%string, (equiv_checker [DUP 4;PUSH 1 (NToWord WLen 0x1%N);Opcode ADD;PUSH 1 (NToWord WLen 0x0%N);DUP 2;DUP 2] [PUSH 1 (NToWord WLen 0x1%N);DUP 5;Opcode ADD;PUSH 1 (NToWord WLen 0x0%N);DUP 2;DUP 2] 4 optimize_id) ).
...
(*
 ...
 O: PUSH 20 PUSH 7 DUP2
*)
Compute ( "ERC721A_run_code_of_0_block_105_1"%string, (equiv_checker [PUSH 1 (NToWord WLen 0x20%N);PUSH 1 (NToWord WLen 0x7%N);DUP 2] [PUSH 1 (NToWord WLen 0x7%N);PUSH 1 (NToWord WLen 0x20%N);SWAP 1;DUP 2] 0 optimize_id) ).
...
(*
 ...
 O: DUP2 DUP7 ISZERO ISZERO SWAP2 SWAP5 KECCAK256 DUP2 PUSH ff NOT DUP3 SLOAD AND OR SWAP1
*)
Compute ( "ERC721A_run_code_of_0_block_105_4"%string, (equiv_checker [DUP 2;DUP 7;Opcode ISZERO;Opcode ISZERO;SWAP 2;SWAP 5;Opcode KECCAK256;DUP 2;PUSH 1 (NToWord WLen 0xff%N);Opcode NOT;DUP 3;Opcode SLOAD;Opcode AND;Opcode OR;SWAP 1] [SWAP 3;DUP 2;SWAP 1;Opcode KECCAK256;DUP 1;Opcode SLOAD;PUSH 1 (NToWord WLen 0xFF%N);Opcode NOT;Opcode AND;DUP 7;Opcode ISZERO;Opcode ISZERO;SWAP 1;DUP 2;Opcode OR;SWAP 1;SWAP 2] 6 optimize_id) ).

(*
 I: SWAP2 SWAP3 SWAP2 PUSH 17307EAB39AB6107E8899845AD3D59BD9653F200F220920489CA2B5937696C31 SWAP2 ADD PUSH 40 MLOAD DUP1 SWAP2 SUB SWAP1
 O: ADD PUSH 40 MLOAD DUP1 SWAP4 SWAP3 SWAP4 SWAP2 SUB PUSH 17307eab39ab6107e8899845ad3d59bd9653f200f220920489ca2b5937696c31 SWAP2
*)
Compute ( "ERC721A_run_code_of_0_block_105_6"%string, (equiv_checker [Opcode ADD;PUSH 1 (NToWord WLen 0x40%N);Opcode MLOAD;DUP 1;SWAP 4;SWAP 3;SWAP 4;SWAP 2;Opcode SUB;PUSH 32 (NToWord WLen 0x17307eab39ab6107e8899845ad3d59bd9653f200f220920489ca2b5937696c31%N);SWAP 2] [SWAP 2;SWAP 3;SWAP 2;PUSH 32 (NToWord WLen 0x17307EAB39AB6107E8899845AD3D59BD9653F200F220920489CA2B5937696C31%N);SWAP 2;Opcode ADD;PUSH 1 (NToWord WLen 0x40%N);Opcode MLOAD;DUP 1;SWAP 2;Opcode SUB;SWAP 1] 4 optimize_id) ).
...
*)
Compute ( "ERC721A_run_code_of_0_block_137_0"%string, (equiv_checker [Opcode RETURNDATASIZE;DUP 1;Opcode RETURNDATASIZE;Opcode ISZERO;PUSH 1 (NToWord WLen 0xc9%N)] [Opcode RETURNDATASIZE;DUP 1;DUP 1;Opcode ISZERO;PUSH 1 (NToWord WLen 0xc9%N)] 0 optimize_id) ).
...
*)
Compute ( "ERC721A_run_code_of_0_block_143_0"%string, (equiv_checker [PUSH 1 (NToWord WLen 0x1%N);DUP 1;PUSH 1 (NToWord WLen 0xe0%N);Opcode SHL;Opcode SUB;Opcode NOT;Opcode AND;SWAP 5;POP;POP;PUSH 4 (NToWord WLen 0xa85bd01%N);SWAP 3;POP;POP;POP;PUSH 1 (NToWord WLen 0xe1%N);Opcode SHL;Opcode EQ;SWAP 1] [PUSH 1 (NToWord WLen 0x1%N);PUSH 1 (NToWord WLen 0x1%N);PUSH 1 (NToWord WLen 0xE0%N);Opcode SHL;Opcode SUB;Opcode NOT;Opcode AND;PUSH 4 (NToWord WLen 0xA85BD01%N);PUSH 1 (NToWord WLen 0xE1%N);Opcode SHL;Opcode EQ;SWAP 1;POP;SWAP 5;SWAP 4;POP;POP;POP;POP] 7 optimize_id) ).
...
*)
Compute ( "ERC721A_run_code_of_0_block_148_0"%string, (equiv_checker [POP;DUP 2;PUSH 1 (NToWord WLen 0x1f%N);Opcode NOT;Opcode ADD;SWAP 2;SWAP 1;Opcode SUB;DUP 2] [POP;DUP 2;SWAP 1;Opcode SUB;PUSH 1 (NToWord WLen 0x1F%N);Opcode NOT;SWAP 1;SWAP 2;Opcode ADD;SWAP 1;DUP 2] 3 optimize_id) ).
...
(*
 ...
 O: SWAP4 PUSH 40 ADD CALLDATALOAD SWAP4 SWAP5 POP POP POP SWAP3
*)
Compute ( "ERC721A_run_code_of_0_block_164_0"%string, (equiv_checker [SWAP 4;PUSH 1 (NToWord WLen 0x40%N);Opcode ADD;Opcode CALLDATALOAD;SWAP 4;SWAP 5;POP;POP;POP;SWAP 3] [SWAP 2;POP;PUSH 1 (NToWord WLen 0x40%N);DUP 5;Opcode ADD;Opcode CALLDATALOAD;SWAP 1;POP;SWAP 3;POP;SWAP 3;POP;SWAP 3] 7 optimize_id) ).
...
*)
Compute ( "ERC721A_run_code_of_0_block_171_0"%string, (equiv_checker [DUP 8;SWAP 2;DUP 8;Opcode ADD;SWAP 2;PUSH 1 (NToWord WLen 0x1f%N);DUP 4;Opcode ADD;Opcode SLT;PUSH 1 (NToWord WLen 0xe8%N)] [DUP 2;DUP 8;Opcode ADD;SWAP 2;POP;DUP 8;PUSH 1 (NToWord WLen 0x1F%N);DUP 4;Opcode ADD;Opcode SLT;PUSH 1 (NToWord WLen 0xe8%N)] 8 optimize_id) ).
...
*)
Compute ( "ERC721A_run_code_of_0_block_179_2"%string, (equiv_checker [SWAP 8;SWAP 11;SWAP 7;SWAP 10;POP;POP;POP;POP;POP;POP;SWAP 3;POP] [DUP 1;SWAP 6;POP;POP;POP;POP;POP;POP;SWAP 3;SWAP 6;SWAP 2;SWAP 5;POP;SWAP 3;POP] 12 optimize_id) ).
...
(*
 ...
 O: SWAP5 SWAP3 PUSH 20 ADD CALLDATALOAD SWAP4 POP POP POP
*)
Compute ( "ERC721A_run_code_of_0_block_189_0"%string, (equiv_checker [SWAP 5;SWAP 3;PUSH 1 (NToWord WLen 0x20%N);Opcode ADD;Opcode CALLDATALOAD;SWAP 4;POP;POP;POP] [SWAP 5;PUSH 1 (NToWord WLen 0x20%N);SWAP 4;SWAP 1;SWAP 4;Opcode ADD;Opcode CALLDATALOAD;SWAP 4;POP;POP;POP] 6 optimize_id) ).
...
(*
 ...
 O: DUP3 DUP2 PUSH 40 ADD
*)
Compute ( "ERC721A_run_code_of_0_block_204_2"%string, (equiv_checker [DUP 3;DUP 2;PUSH 1 (NToWord WLen 0x40%N);Opcode ADD] [PUSH 1 (NToWord WLen 0x40%N);DUP 2;Opcode ADD;DUP 4;SWAP 1] 3 optimize_id) ).

(*
 I: PUSH 80 PUSH 60 DUP3 ADD DUP2 SWAP1
 O: PUSH 80 DUP1 DUP3 PUSH 60 ADD
*)
Compute ( "ERC721A_run_code_of_0_block_204_3"%string, (equiv_checker [PUSH 1 (NToWord WLen 0x80%N);DUP 1;DUP 3;PUSH 1 (NToWord WLen 0x60%N);Opcode ADD] [PUSH 1 (NToWord WLen 0x80%N);PUSH 1 (NToWord WLen 0x60%N);DUP 3;Opcode ADD;DUP 2;SWAP 1] 1 optimize_id) ).
