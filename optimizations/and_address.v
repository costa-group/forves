...
(* AND(ADDRESS,2^160-1) = ADDRESS
   AND(2^160-1,ADDRESS) = ADDRESS *)
Definition optimize_and_address_sbinding : opt_smap_value_type := 
fun (val: smap_value) =>
...
Lemma optimize_and_address_sbinding_smapv_valid:
opt_smapv_valid_snd optimize_and_address_sbinding.
Proof.
...
destruct (is_address_mask arg1 arg2 fcmp n instk_height sb evm_stack_opm || 
          is_address_mask arg2 arg1 fcmp n instk_height sb evm_stack_opm) 
  eqn: is_address; try inject_rw Hoptm_sbinding eq_val'.
unfold orb in is_address.
...
destruct (is_address_mask arg1 arg2 fcmp n instk_height sb evm_stack_opm) 
  eqn: is_address_arg1_arg2.
- injection Hoptm_sbinding as eq_val' _.
  rewrite <- eq_val'. 
  unfold is_address_mask in is_address_arg1_arg2.
  ...
  pose proof (valid_follow_in_smap sb arg1 instk_height n evm_stack_opm 
    (SymOp ADDRESS []) idx1' sb1' Hvalid_arg1 Hvalid eq_follow_arg1)
    as Hvalid2.
  destruct Hvalid2 as [Hvalid_smpv [_ Himpl]].
  pose proof (not_basic_value_smv_symop ADDRESS []) as eq_not_basic.
...
- destruct (is_address_mask arg2 arg1 fcmp n instk_height sb evm_stack_opm) 
  eqn: is_address_arg2_arg1; try discriminate.
  injection Hoptm_sbinding as eq_val' _.
  rewrite <- eq_val'. 
  unfold is_address_mask in is_address_arg2_arg1.
  ...
  pose proof (valid_follow_in_smap sb arg2 instk_height n evm_stack_opm 
    (SymOp ADDRESS []) idx2' sb2' Hvalid_arg2 Hvalid eq_follow_arg2)
    as Hvalid2.
  destruct Hvalid2 as [Hvalid_smpv [_ Himpl]].
  pose proof (not_basic_value_smv_symop ADDRESS []) as eq_not_basic.
...
Lemma optimize_and_address_sbinding_snd:
opt_sbinding_snd optimize_and_address_sbinding.
Proof.
...
- (* valid_sbindings *)
  ...
  apply optimize_and_address_sbinding_smapv_valid. 
...
- (* evaluation is preserved *) 
  ...
  destruct r1 as [|arg2 r2]; try inject_rw Hoptm_sbinding eq_val'.
  destruct r2; try inject_rw Hoptm_sbinding eq_val'.
  destruct (is_address_mask arg1 arg2 fcmp idx instk_height sb evm_stack_opm
         || is_address_mask arg2 arg1 fcmp idx instk_height sb evm_stack_opm)
    eqn: eq_is_address; try inject_rw Hoptm_sbinding eq_val'.
  unfold orb in eq_is_address.
  destruct (is_address_mask arg1 arg2 fcmp idx instk_height sb evm_stack_opm)
    eqn: is_address_arg1_arg2.
  + unfold is_address_mask in is_address_arg1_arg2.
    ...
    rewrite <- eq_arg1v. unfold evm_address.
  ...
  + unfold is_address_mask in eq_is_address.
    ...
    rewrite <- eq_arg2v. unfold evm_address.
