...
module Opt_iszero_sub :
 sig
  ...
  val optimize_iszero_sub_sbinding : Optimizations_Def.opt_smap_value_type
 end
...
module Opt_iszero2_gt :
 sig
  val optimize_iszero2_gt_sbinding : Optimizations_Def.opt_smap_value_type
 end

module Opt_iszero2_lt :
 sig
  val optimize_iszero2_lt_sbinding : Optimizations_Def.opt_smap_value_type
 end
...
module Opt_xor_xor :
 sig
  ...
  val optimize_xor_xor_sbinding : Optimizations_Def.opt_smap_value_type
 end
...
module Opt_or_or :
 sig
  ...
  val optimize_or_or_sbinding : Optimizations_Def.opt_smap_value_type
 end
...
module Opt_or_and :
 sig
  ...
  val optimize_or_and_sbinding : Optimizations_Def.opt_smap_value_type
 end
