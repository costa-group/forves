...
Proof.
  ...
  repeat split.
  - apply H_safe_sstack_val_cmp_ext.
  - apply H_safe_smemory_cmp_ext.
  - apply H_safe_sstorage_cmp_ext.
  - apply H_safe_sha3_cmp_ext.
Qed.
