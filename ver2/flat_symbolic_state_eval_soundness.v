...
Lemma eval_sexpr_snd:
  forall sb sv stk mem strg ctx ops flat_sb fsv,
    bindings_to_flat_bindings sb = Some flat_sb ->
    sstack_val_to_sexpr sv flat_sb = Some fsv ->
    eval_sstack_val sv stk mem strg ctx sb ops = eval_sexpr fsv stk mem strg ctx ops.
Proof.
  induction sb as [|p sb' IHsb'].
  - simpl.
    intros sv stk mem strg ctx ops flat_sb fsv H_bs_to_flat_bs H_sstack_val_to_sexpr.
    ...
    + 
      ...
      * simpl in E_smap_value_to_sexpr.
        ...
        ++ destruct (length sexpr_args =? nrags) eqn:E_len_sexpr_nargs.
           +++ fold eval_sexpr.
               assert (H_maps_option_aux: forall args sexpr_args, map_option (fun sv' : sstack_val => sstack_val_to_sexpr sv' flat_sb') args = Some sexpr_args -> map_option (fun sv' : sstack_val => eval_sstack_val sv' stk mem strg ctx sb' ops) args = map_option (fun fsv' : sexpr => eval_sexpr fsv' stk mem strg ctx ops) sexpr_args).
               ...
               ++++ intro args0. induction args0 as [| a0 args0' IHargs0'].
                    ...
                    pose proof (map_option_len sstack_val sexpr (fun sv' : sstack_val => sstack_val_to_sexpr sv' flat_sb') (a0::args0') sexpr_args0 H_map_option_sexpr_args) as E_len_args_sexpr_args.
                          ...
                          pose proof (IHsb' a0 stk mem strg ctx ops flat_sb' asexpr0 H_flat_sb'_refl  H_map_option_sexpr_args_1 ) as H_map_option_aux_3.
                          rewrite <- H_map_option_aux_3. 
                          destruct (eval_sstack_val a0 stk mem strg ctx sb' ops); try reflexivity.
      ...
      * simpl in E_smap_value_to_sexpr.
        ...
        assert(H_map_option_0: forall smem sexpr_mem_updates,
                  ...
                  map_option
                    (eval_common.EvalCommon.instantiate_memory_update (fun sv : sstack_val => eval_sstack_val sv stk mem strg ctx sb' ops)) smem = map_option (eval_common.EvalCommon.instantiate_memory_update (fun sv : sexpr => eval_sexpr sv stk mem strg ctx ops)) sexpr_mem_updates). 
        ...
        ++ intros smem0. induction smem0 as [|supdate0 smem0' IHsmem0'].
           ...
           +++ intros sexpr_mem_updates0 H_map_option_0_1.
               ...
               destruct supdate0 eqn:E_supdate0; try (
                                                     ...
                                                     pose proof (IHsb' offset0 stk mem strg ctx ops flat_sb' s H_flat_sb'_refl E_sstack_val_to_sexpr_offset0) as H_map_option_aux_3;
                                                     rewrite H_map_option_aux_3;
                                                     pose proof (IHsb' value stk mem strg ctx ops flat_sb' s0 H_flat_sb'_refl E_sstack_val_to_sexpr_value) as H_map_option_aux_4;
        ...
        ++ pose proof (H_map_option_0 smem sexpr_mem_updates E_map_option_mem_updates) as H_map_option_1.
           ...
           assert (H_flat_sb'_refl: Some flat_sb' = Some flat_sb'). reflexivity.
           pose proof (IHsb' offset stk mem strg ctx ops flat_sb' sexpr_offset H_flat_sb'_refl E_sstack_val_to_sexpr_offset) as IHsb'_0.
           rewrite IHsb'_0.
           reflexivity.
      * simpl in E_smap_value_to_sexpr.
        ...
        assert(H_map_option_0: forall sstrg sexpr_strg_updates,
                  ...
                  map_option
                    (eval_common.EvalCommon.instantiate_storage_update (fun sv : sstack_val => eval_sstack_val sv stk mem strg ctx sb' ops)) sstrg = map_option (eval_common.EvalCommon.instantiate_storage_update (fun sv : sexpr => eval_sexpr sv stk mem strg ctx ops)) sexpr_strg_updates).
        ...
        ++ intros sstrg0. induction sstrg0 as [|supdate0 sstrg0' IHsstrg0'].
           ...
           +++ intros sexpr_strg_updates0 H_map_option_0_1.
               ...
               assert (H_flat_sb'_refl: Some flat_sb' = Some flat_sb'). reflexivity.
               pose proof (IHsb' key1 stk mem strg ctx ops flat_sb' s H_flat_sb'_refl E_sstack_val_to_sexpr_key1) as H_map_option_aux_3.
               rewrite H_map_option_aux_3.
               pose proof (IHsb' value stk mem strg ctx ops flat_sb' s0 H_flat_sb'_refl E_sstack_val_to_sexpr_value) as H_map_option_aux_4.
               rewrite H_map_option_aux_4.
        ...
        ++ pose proof (H_map_option_0 sstrg sexpr_strg_updates E_map_option_strg_updates) as H_map_option_0_1.
           ...
           assert (H_flat_sb'_refl: Some flat_sb' = Some flat_sb'). reflexivity.
           pose proof (IHsb' key0 stk mem strg ctx ops flat_sb' sexpr_key0 H_flat_sb'_refl E_sstack_val_to_sexpr_key0) as IHsb'_0.
           rewrite IHsb'_0.
           reflexivity.
      ...
      * simpl in E_smap_value_to_sexpr.
        ...
        ++ pose proof (H_map_option_0 smem sexpr_mem_updates E_map_option_mem_updates) as H_map_option_1.
           ...
           pose proof (IHsb' offset stk mem strg ctx ops flat_sb' sexpr_offset H_flat_sb'_refl E_sstack_val_to_sexpr_offset) as IHsb'_0.
           rewrite IHsb'_0.
           pose proof (IHsb' size stk mem strg ctx ops flat_sb' sexpr_size H_flat_sb'_refl E_sstack_val_to_sexpr_size) as IHsb'_1.
           rewrite IHsb'_1.
           reflexivity.
...
Lemma eval_sexp_map:
  forall l flat_l sb flat_sb stk mem strg ctx ops,
    bindings_to_flat_bindings sb = Some flat_sb ->
    ...
    map_option (fun sv : sexpr => eval_sexpr sv stk mem strg ctx ops) flat_l =
      map_option (fun sv : sstack_val => eval_sstack_val sv stk mem strg ctx sb ops) l.
Proof.
  induction l as [|a l' IHl'].
  - intros flat_l sb flat_sb stk mem strg ctx ops H_flat_sb H_map_option_0.
  ...
  - intros flat_l sb flat_sb stk mem strg ctx ops H_flat_sb H_map_option_0.
    ...
    pose proof (eval_sexpr_snd sb a stk mem strg ctx ops flat_sb flat_a H_flat_sb H_map_option_1_1) as H_eval_sexpr_snd.
    simpl.
    rewrite H_eval_sexpr_snd.
    pose proof (IHl' flat_l' sb flat_sb stk mem strg ctx ops H_flat_sb H_map_option_1_2) as IHl'_0.
    rewrite IHl'_0.
    reflexivity.
Qed.
...
Lemma eval_flat_sstack_snd:
  forall sst fsst stk mem strg ctx ops,
    sstate_to_flat_sstate sst = Some fsst ->
    eval_flat_sstack stk mem strg ctx fsst ops = eval_sstack stk mem strg ctx sst ops.
Proof.
  intros sst fsst stk mem strg ctx ops H_sst_to_fsst.
  unfold eval_flat_sstack.
  unfold eval_sstack.
  unfold eval_sstack'.
  pose proof (sst_to_fsst_instk_height sst fsst H_sst_to_fsst) as H_sst_to_fsst_instk_height.
  rewrite H_sst_to_fsst_instk_height.
  destruct (length stk =? get_instk_height_fsst fsst) eqn:E_len_stk; try reflexivity.
  destruct (get_smap_sst sst) as [maxid sb] eqn:E_get_smap.
  unfold sstate_to_flat_sstate in H_sst_to_fsst.
  rewrite E_get_smap in H_sst_to_fsst.
  ...
  rewrite <- H_sst_to_fsst.
  simpl.
  pose proof (eval_sexp_map (get_stack_sst sst) flat_sstk sb flat_sb stk mem strg ctx ops E_bindings E_flat_sstk) as H_eval_sexp_map.
  apply H_eval_sexp_map.
Qed.

Lemma eval_flat_smemory_map:
  forall sb flat_sb stk mem strg ctx ops smem flat_smem,
    bindings_to_flat_bindings sb = Some flat_sb ->
  ...
  map_option (eval_common.EvalCommon.instantiate_memory_update (fun sv : sexpr => eval_sexpr sv stk mem strg ctx ops)) flat_smem =
    map_option (eval_common.EvalCommon.instantiate_memory_update (fun sv : sstack_val => eval_sstack_val sv stk mem strg ctx sb ops)) smem.
Proof.
  intros sb flat_sb stk mem strg ctx ops.
  ...
  - intros flat_smem H_sbindings H_map_option.
    ...
    destruct u; try (
                    ...
                    pose proof (eval_sexpr_snd sb offset stk mem strg ctx ops flat_sb flat_offset H_sbindings E_sstack_val_to_sexpr_offset) as H_eval_sexpr_snd_offset;
                    rewrite H_eval_sexpr_snd_offset;

                    pose proof (eval_sexpr_snd sb value stk mem strg ctx ops flat_sb flat_value H_sbindings E_sstack_val_to_sexpr_value) as H_eval_sexpr_snd_value;
...
Lemma eval_flat_smemory_snd:
  forall sst fsst stk mem strg ctx ops,
    sstate_to_flat_sstate sst = Some fsst ->
    eval_flat_smemory stk mem strg ctx fsst ops = eval_smemory stk mem strg ctx sst ops.
Proof.
  intros sst fsst stk mem strg ctx ops H_sst_to_fsst.
  ...
  pose proof (eval_flat_smemory_map sb flat_sb stk mem strg ctx ops (get_memory_sst sst) flat_smem E_bindings E_flat_smem) as H_eval_flat_smemory_map.
  rewrite H_eval_flat_smemory_map.
  reflexivity.
Qed.

Lemma eval_flat_sstorage_map:
  forall sb flat_sb stk mem strg ctx ops sstrg flat_sstrg,
    bindings_to_flat_bindings sb = Some flat_sb ->
  ...
  map_option (eval_common.EvalCommon.instantiate_storage_update (fun sv : sexpr => eval_sexpr sv stk mem strg ctx ops)) flat_sstrg =
    map_option (eval_common.EvalCommon.instantiate_storage_update (fun sv : sstack_val => eval_sstack_val sv stk mem strg ctx sb ops)) sstrg.
Proof. (* it is the same as eval_flat_smemory_map *)
  ...
  - intros flat_sstrg H_sbindings H_map_option.
    ...
    pose proof (eval_sexpr_snd sb key stk mem strg ctx ops flat_sb flat_key H_sbindings E_sstack_val_to_sexpr_key) as H_eval_sexpr_snd_key.
...
Lemma eval_flat_sstorage_snd:
  forall sst fsst stk mem strg ctx ops,
    sstate_to_flat_sstate sst = Some fsst ->
    eval_flat_sstorage stk mem strg ctx fsst ops = eval_sstorage stk mem strg ctx sst ops.
Proof.
  intros sst fsst stk mem strg ctx ops H_sst_to_fsst.
  ...
  pose proof (eval_flat_sstorage_map sb flat_sb stk mem strg ctx ops (get_storage_sst sst) flat_sstrg E_bindings E_flat_sstrg) as H_eval_flat_sstorage_map.
