...
Module SStackValCmpImpl.
  ...
  Fixpoint basic_compare_sstack_val_w_eq_chk (smemory_cmp: smemory_cmp_ext_t) (sstorage_cmp: sstorage_cmp_ext_t) (sha3_cmp: sha3_cmp_ext_t) (d: nat) (sv1 sv2: sstack_val) (maxidx1: nat) (sb1: sbindings) (maxidx2: nat) (sb2: sbindings) (instk_height: nat) (ops: stack_op_instr_map) : bool :=
    if (trivial_compare_sstack_val smemory_cmp sstorage_cmp sha3_cmp d sv1 sv2 maxidx1 sb1 maxidx2 sb2 instk_height ops)
    then true
    else
    match d with
    | 0 => false
            ...
            | Some (FollowSmapVal smv2 maxidx2' sb2') =>
                ...
                | SymOp label1 args1, SymOp label2 args2 =>
                    if label1 =?i label2 then
                      match ops label1 with
                        OpImp _ _ H_Comm _ =>
                          match (fold_right_two_lists (fun e1 e2 => basic_compare_sstack_val_w_eq_chk_rec e1 e2 maxidx1' sb1' maxidx2' sb2' instk_height ops) args1 args2) with
                          | true => true
                          | false =>
                              match H_Comm with
                              | Some comm_proof =>
                                  match args1, args2 with
                                  | [a1;a2],[b1;b2] =>
                                      if basic_compare_sstack_val_w_eq_chk_rec a1 b2 maxidx1' sb1' maxidx2' sb2' instk_height ops
                                      then basic_compare_sstack_val_w_eq_chk_rec a2 b1 maxidx1' sb1' maxidx2' sb2' instk_height ops
                                      else false
                                  | _, _ => false
                                  end
                              | None => false
                ...
                | SymMLOAD soffset1 smem1, SymMLOAD soffset2 smem2 =>
                    if basic_compare_sstack_val_w_eq_chk smemory_cmp sstorage_cmp sha3_cmp d' soffset1 soffset2 maxidx1' sb1' maxidx2' sb2' instk_height ops
                    then smemory_cmp basic_compare_sstack_val_w_eq_chk_rec smem1 smem2 maxidx1' sb1' maxidx2' sb2' instk_height ops
                    else false
                | SymSLOAD skey1 sstrg1, SymSLOAD skey2 sstrg2 => 
                    if basic_compare_sstack_val_w_eq_chk smemory_cmp sstorage_cmp sha3_cmp d' skey1 skey2 maxidx1' sb1' maxidx2' sb2' instk_height ops
                    then sstorage_cmp basic_compare_sstack_val_w_eq_chk_rec sstrg1 sstrg2 maxidx1' sb1' maxidx2' sb2' instk_height ops
                    else false
                | SymSHA3 soffset1 ssize1 smem1, SymSHA3 soffset2 ssize2 smem2 =>
                    (* the nested if is to avoid using band *)
                    if (if basic_compare_sstack_val_w_eq_chk_rec soffset1 soffset2 maxidx1' sb1' maxidx2' sb2' instk_height ops then
                          if basic_compare_sstack_val_w_eq_chk_rec ssize1 ssize2 maxidx1' sb1' maxidx2' sb2' instk_height ops then
                            smemory_cmp basic_compare_sstack_val_w_eq_chk_rec smem1 smem2 maxidx1' sb1' maxidx2' sb2' instk_height ops 
                          else
                            false
                        else
                          false)
                    then true
                      ...
                      sha3_cmp basic_compare_sstack_val_w_eq_chk_rec soffset1 ssize1 smem1 soffset2 ssize2 smem2 maxidx1' sb1' maxidx2' sb2' instk_height ops
                | _, _ => false
                end
            end
        end
